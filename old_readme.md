# Knowledge Mining Bootcamp - Applying AI to Business Documents using Azure Cognitive Search

## Welcome 
Knowledge Mining is the process of discovering actionable information from large sets of unstructured data, like text or images. It uses Artificial Intelligence to derive patterns and hidden information that exist in data. It can be used to guarantee compliance, enrich searches, or automate processes, among other business processes. 

**Every company** has contracts, memos, presentations, imagens, emails and other types of unstructured data. **All of them** can benefit from a solution that detects oraganizations, key phrases, locations, sentiment and other cognitive skills from the business data and loads it into a 

[Coginite Search](https://docs.microsoft.com/en-us/azure/search/cognitive-search-concept-intro) is the Microsoft's technology for Knowledge Mining. It creates searchable encriched information out of unstructured data, pushing the created metadata into an Azure Search index. [Azure Search](https://azure.microsoft.com/en-us/services/search/) indexes the created metadata for an advanced search experience, alowing out of the box ranking, natual language processing, suggestions and more.

This two days training will focus on hands-on activities that develop proficiency with Cognitive Search, an Azure Search AI-oriented capability announced at [Microsoft Build 2018](https://www.microsoft.com/en-us/build). These labs assume an introductory to intermediate knowledge of [Visual Studio](https://www.visualstudio.com/vs/community/), the [Azure Portal](https://portal.azure.com), and [Azure Functions](https://azure.microsoft.com/en-us/services/functions/). If you are not at that skill level, we have prerequisite materials below that you **need** to complete prior to beginning this training.
...
At the end of this bootcamp, you should have learned:
